    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizBinding.option1.setOnClickListener(v -> {
            ...
            if (selectedOption == 0) {
                ...
                //When user click on any option then the next button will be enabled
                quizBinding.nextBtn.setEnabled(true);
                quizBinding.nextBtn.setBackgroundResource(R.drawable.round_start);
